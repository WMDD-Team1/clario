...
const InsightCard: React.FC<StatCardProps> = ({ title, month, text }) => {
  return (
    <div
      ...
      w-full max-w-[426px] sm:max-w-[583px] md:max-w-[426px] p-5 rounded-[20px]
      bg-white
    ...
    >
      ...
      <div className="flex justify-between items-center w-full">
        <span className="text-xs font-semibold --page-title font-redhat text-[18px] not-italic leading-normal">{month}</span>
