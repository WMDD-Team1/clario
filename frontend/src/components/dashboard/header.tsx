export function Header() {
  return (
    <header className="top-0 left-0 right-0 h-20 flex items-center justify-between px-4 md:px-6 z-10">
      <div className="flex items-center gap-3 bg-[#ededed] p-2 rounded-full">
        <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#FFFFFF]" />
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-black" />
      </div>
    </header>
  )
}