...
const Slide: React.FC<SlideProps> = ({
  ...
  return (
    <>
      <div
        className={`fixed inset-0 transition-all backdrop-blur-sm bg-[var(--primitive-colors-brand-primary-500-base)]/40 duration-300 z-1010 ${
      ...
      >
        <div
          ...
          onClick={onClose}
        >
          <button className="text-[var(--primitive-colors-gray-light-mode-600)] hover:text-gray-700 transition-colors rounded-2xl cursor-pointer">
