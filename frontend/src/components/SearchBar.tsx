  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          !needCollapse
            ? 'flex items-center bg-[#F8FBFF] border border-[var(--sublight)] rounded-[20px] px-4 py-4 relative'
            : isSearchOpen
              ? 'flex absolute left-0 right-0 mx-6 bg-[#F8FBFF] border border-[var(--sublight)] rounded-[15px] px-4 py-4 items-center z-10 md:relative md:left-auto md:right-auto md:mx-0'
              : 'hidden md:flex items-center bg-[#F8FBFF] border border-[var(--sublight)] rounded-[20px] px-4 py-4 relative'
        }`}
      >
