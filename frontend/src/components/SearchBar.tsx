  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          !needCollapse
            ? 'flex items-center bg-[#F8FBFF] border border-gray-200 rounded-full px-4 py-2 relative'
            : isSearchOpen
              ? 'flex absolute left-0 right-0 mx-6 bg-[#F8FBFF] border border-gray-200 rounded-full px-4 py-2 items-center z-10 md:relative md:left-auto md:right-auto md:mx-0'
              : 'hidden md:flex items-center bg-[#F8FBFF] border border-gray-200 rounded-full px-4 py-2 relative'
        }`}
      >
