  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          !needCollapse
            ? 'flex items-center bg-[#F8FBFF] border border-gray-200 rounded-[20px] px-4 py-2 relative'
            : isSearchOpen
              ...
              : 'hidden md:flex items-center bg-[#F8FBFF] border border-gray-200 rounded-[20px] px-4 py-2 relative'
        }`}
      >
