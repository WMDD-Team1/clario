  ...
  return (
    <>
      <div className="flex justify-start items-center gap-2 mb-7 sticky top-35 z-100 bg-[var(--background)]">
        ...
        <h2>{project.name}</h2>
        <StatusPill
          status={project.isArchived ? 'Archived' : project.isActive ? 'Active' : 'Inactive'}
        />
      </div>
      <div className="hidden md:flex gap-5">
        ...
        <div className="overflow-x-auto overflow-y-hidden flex-1 min-w-0">
          ...
          <div className="mt-[20px]">
            {view.key == 'milestones' ? (
              <Milestones milestones={project.milestones ?? []} projectId={project.id} />
            ) : (
      ...
      <div className="md:hidden mt-5">
        <TabsButton
          tabs={['overview', 'milestones', 'invoices']}
