      ...
      {stats.map(({ label, value }, idx) => {
        ...
        return (
          <InsightCard
            ...
            title={label}
            value={value}
            className={`flex flex-col justify-center items-center h-[96px] p-4 rounded-2xl border border-[var(--sublight-2)] bg-[var(--general-alpha) transition-all duration-200 ${
